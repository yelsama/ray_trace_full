...
static void	rotate_around_x(t_tuple *tpl, float cos_d, float sin_d)
{
	float	tmp[2];
...
static void	rotate_around_y(t_tuple *tpl, float cos_d, float sin_d)
{
	float	tmp[2];
...
static void	rotate_around_z(t_tuple *tpl, float cos_d, float sin_d)
{
	float	tmp[2];
