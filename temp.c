...
/*   Updated: 2023/06/17 22:03:38 by ymohamed         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	alive->p[0] = fill_plane((t_point_vector){0.0, -2.2, 100.0, 1}, (t_point_vector){-1.0, 1.0, 0.0, 0},  (t_color){131, 131, 126});
	...
	float h_r[] = {4.0, 1.0};
	alive->c[0] = fill_cylndr((t_point_vector){0.0, 0.0, 0.0, 1}, (t_point_vector){0.0, 1.0, 0.0, 1}, (t_color){240, 151, 41}, h_r);
